...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      {
        icon: 'https://www.yuelai.com/favicon.ico',
        title: '蓝湖',
        desc: '蓝湖',
        link: 'https://lanhuapp.com/dashboard/#/item?tid=e81660fc-8e4c-4691-acf4-e38725e0ec57',
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://ai.kezhan365.com/favicon.ico',
        title: 'AI工具集（最全）',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://regexlearn.com/Done.webp',
        title: '学习正则表达式',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'Node.js笔记',
        desc: 'Node.js笔记系统整理',
        link: 'https://blog.poetries.top/node-learning-notes/',
      },
    ],
  },
  {
