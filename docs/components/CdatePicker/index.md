  ...
  <c-layout-page class="single_Date">
    <c-layout-page-item>
      ...
      <div class="box_content">
        <div class="box_flex">
          <div>选择日期</div>
          <c-date-picker v-model="date" :size="size" @change="change($event, 'date', date)" />
        </div>
        <div class="box_flex">
          <div>选择周</div>
          <c-date-picker
...
```vue preview
<template>
  <c-layout-page class="slotCustomize">
    <c-layout-page-item>
      <div class="box_content">
        <div class="box_flex">
